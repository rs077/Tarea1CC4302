...
int nMain( int argc, char **argv ) {
  ...
  inicializar(3);
  verificar= TRUE;
  nPrintf("Test 1: se transbordan 4 vehiculos, 2 a Chacao y 2 a Pargua secuencialmente\n");
  for (k=0; k<10; k++)
  { /* Se transbordan realizaran 4 transbordos de manera secuencial para dos islenos y dos nortenos */
...
#define T 900
    nTask tasks[T];
    int t;
    nPrintf("Test de esfuerzo ampliado.  Se demora bastante!\n");
    nSetTimeSlice(1);
    verificar= FALSE;
    achacao= 0;
    apargua= 0;
